    ...
    <div class="container">
        ...
        <div class="card shadow-lg rounded-4 p-4 bg-white">
            <div class="card-body">
                ...
                <h5 class="mt-4">Usos Prohibidos</h5>
                <ul>
                ...
                <h5 class="mt-4">Derechos de propiedad intelectual e industrial</h5>
                ...
                <h5 class="mt-4">Enlaces externos</h5>
                ...
                <h5 class="mt-4">Otras condiciones de uso</h5>
                <p>Este sitio y sus contenidos pertenecen a EntreHobbies, cuya sede social se encuentra en [direcci&oacute;n f&iacute;sica], con CIF [CIF].</p>
                ...
                <h5 class="mt-4">Exclusi&oacute;n de garant&iacute;as y responsabilidad</h5>
                <ul>
                ...
                <h5 class="mt-4">Modificaciones</h5>
                ...
                <h5 class="mt-4">Ley aplicable y jurisdicci&oacute;n</h5>
                ...
                <h5 class="mt-4">C&oacute;digo &eacute;tico de Conducta</h5>
                ...
                <h5 class="mt-4">Resoluci&oacute;n de Litigios</h5>
