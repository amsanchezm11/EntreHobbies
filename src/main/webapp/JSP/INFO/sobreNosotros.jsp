        ...
        <div class="row g-0">
            ...
            <div class="col-md-7 d-flex align-items-center">
                <div class="card-body">
                    ...
                    <p class="card-text text-body">
                        En <strong>EntreHobbies</strong> creemos en conectar personas con intereses comunes. Esta plataforma est&aacute; hecha para ti: para que compartas tus aficiones, conozcas nuevas amistades y vivas experiencias únicas.
                    </p>
                </div>
            </div>
        </div>
