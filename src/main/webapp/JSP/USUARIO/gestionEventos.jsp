...
<head>
    <jsp:include page="/INC/cabecera.jsp">
        <jsp:param name="titulo" value="Todos mis eventos"/>
        <jsp:param name="estilo" value="${estilo}"/>
    </jsp:include>
    <script type="module" src="${contexto}/JS/BOOTSTRAPTABLE/cargarEventosUsuario.js" defer></script>
</head>
...
<div class="container-fluid">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-9 col-lg-10 mt-4">
            <h2 class="text-light text-center text-footer">Todos mis eventos</h2>

            <table id="tablaEventosUsuario" class="table table-striped"
                   data-search="true"
                ...
                <tr>
                    ...
                    <th data-field="subcategoria" data-sortable="true">Subcategor&iacute;a</th>
