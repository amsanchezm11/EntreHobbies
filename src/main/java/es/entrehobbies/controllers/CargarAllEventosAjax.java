...
@WebServlet(name = "CargarAllEventosAjax", value = "/CargarAllEventosAjax")
public class CargarAllEventosAjax extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Object[]> lista = daoE.getAllEventosResumen();
